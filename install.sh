...
cmake_address_default="https://github.com/Kitware/CMake/releases/download/v3.17.0/cmake-3.17.0.tar.gz"
openssl_address_default="https://www.openssl.org/source/openssl-1.1.1f.tar.gz"
python_address_default="https://www.python.org/ftp/python/2.7.17/Python-2.7.17.tgz"
python3_address_default="https://www.python.org/ftp/python/3.8.2/Python-3.8.2.tgz"
...
curl_address_default="https://curl.haxx.se/download/curl-7.69.1.tar.gz"
...
php_address_default="https://github.com/php/php-src/archive/php-7.4.4.tar.gz"
