...
cmake_address_default="https://github.com/Kitware/CMake/releases/download/v3.16.0/cmake-3.16.0.tar.gz"
...
curl_address_default="https://curl.haxx.se/download/curl-7.67.0.tar.gz"
...
php_address_default="https://github.com/php/php-src/archive/php-7.4.0.tar.gz"
nginx_address_default="https://nginx.org/download/nginx-1.17.6.tar.gz"
